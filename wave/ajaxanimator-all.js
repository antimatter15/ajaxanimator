...
Ax.set_version(
  /*START*/
  {
    app: 'Ajax Animator',
    build: 773,
    release: '0.20.05 Wave',
    dev: false,
    stability: 'Beta',
    date: 1325382208.9469,
  }
  /*STOP*/
)
/*End Of File*/
...
Ext.BLANK_IMAGE_URL = 'https://antimatter15.github.io/ajaxanimator/cdn/theme/images/default/s.gif'
...
Ax.files = {
  ...
  xssds:
    ...
    '//datastore-service.appspot.com/',
  xsave:
    (location.protocol == 'file:' ? 'http:' : location.protocol) +
    '//datastore-service.appspot.com/saveproxy',
  ...
  themes: 'https://antimatter15.github.io/ajaxanimator/cdn/theme/css/',
}
...
wave2.pseudowave = {
  ...
  toString: function() {
    return Ext.util.JSON.encode(wave2._state)
  },
...
wave2.isPlayback = function() {
  ...
  if (!wave2.fake()) {
    if (new Date().getTime() / 1000 < 1254471241 + 592653) {
      //10 / 2 / 2009 @ 3:14
  ...
  if (window.wave) {
    if (wave.isInWaveContainer()) {
      ...
      Ext.MessageBox.alert(
        'Wave Synchronization API Failed to Load',
...
Ax.lockchange = function(change) {
  ...
  wave2.loop(function(shape) {
    ...
    if (Ax.canvas.getShapeById(shape) && lock) {
      ...
      set.push(
        Ax.canvas.draw
          .rect(txb.x - 5, txb.y, txb.width + 10, txb.height, 3)
...
Datastore.prototype.send = function(p, callback) {
  var tc = this,
    param =
      'act=' +
      encodeURIComponent(p.act) +
      '&group=' +
      encodeURIComponent(p.group) +
      '&type=' +
      encodeURIComponent(p.type) +
      '&data=' +
      encodeURIComponent(p.data) +
      '&key=' +
      encodeURIComponent(p.key) +
      '&index=' +
      encodeURIComponent(p.index)
  if (this.proxy) {
...
Datastore.prototype.idx = function(type, index, cbk) {
  // get by index
  this.send({ act: 'idx', group: this.group, type: type, index: index }, cbk)
}

Datastore.prototype.ridx = function(type, index, cbk) {
...
Ext.ux.base64 = {
  ...
  encode: function(decStr) {
    ...
    if (decStr.length - i > 0 && decStr.length - i < 3) {
      ...
      bits =
        ((decStr.charCodeAt(i++) & 0xff) << 16) | (dual ? (decStr.charCodeAt(i) & 0xff) << 8 : 0)
      encOut +=
        base64s.charAt((bits & 0x00fc0000) >> 18) +
        base64s.charAt((bits & 0x0003f000) >> 12) +
...
Ext.extend(Ext.ux.ThemeMenu, Ext.menu.Menu, {
  ...
  setTheme: function(id) {
    ...
    for (var i = 0; i < 4; i++) {
      //up to 4 themes on top of each other
      if (themes[i]) {
...
Ext.extend(Ext.ux.grid.CellActions, Ext.util.Observable, {
   ...
   */
  tpl:
    '<div class="ux-cell-value" style="padding-left:{padding}px">' +
...
window.Raphael = (function() {
  var at = /[, ]+/,
    m = document,
    ad = window,
    aj = { was: 'Raphael' in ad, is: ad.Raphael },
    l = function() {
      if (l.is(arguments[0], 'array')) {
        var e = arguments[0],
          E = q[ao](l, e.splice(0, 3 + l.is(e[0], ah))),
          av = E.set()
        for (var au = 0, aw = e[z]; au < aw; au++) {
          var R = e[au] || {}
          ;({ circle: 1, rect: 1, path: 1, ellipse: 1, text: 1, image: 1 }[h](R.type) &&
            av[ae](E[R.type]().attr(R)))
        }
        return av
      }
      return q[ao](l, arguments)
    },
    d = {},
    G = ['click', 'dblclick', 'mousedown', 'mousemove', 'mouseout', 'mouseover', 'mouseup'],
    w = '',
    h = 'hasOwnProperty',
    v = 'prototype',
    f = 'setAttribute',
  ...
  l.type =
    ad.SVGAngle ||
    m.implementation.hasFeature('http://www.w3.org/TR/SVG11/feature#BasicStructure', '1.1')
      ? 'SVG'
      : 'VML'
  ...
  l.hsb2rgb = ar(function(az, ax, aD) {
    if (l.is(az, 'object') && 'h' in az && 's' in az && 'b' in az) {
      aD = az.b
      ax = az.s
      az = az.h
    }
    ...
    var aw = ~~(az * 6),
      ...
      E = aD * (1 - ax * aA),
      aF = aD * (1 - ax * (1 - aA))
    au = [aD, E, R, R, aF, aD, aD][aw]
    av = [aF, aD, aD, E, R, R, aF][aw]
    aE = [R, R, aF, aD, aD, E, R][aw]
    au *= 255
    av *= 255
    aE *= 255
    var aB = { r: au, g: av, b: aE },
      e = (~~au)[j](16),
      ay = (~~av)[j](16),
      aC = (~~aE)[j](16)
    e = e[Q](Y, '0')
  ...
  l.rgb2hsb = ar(function(e, i, ax) {
    if (l.is(e, 'object') && 'r' in e && 'g' in e && 'b' in e) {
      ax = e.b
      i = e.g
      e = e.r
    }
    ...
    return { h: au, s: R, b: av }
  }, l)
  l._path2string = function() {
    var R = w,
      aw
    for (var E = 0, au = this[z]; E < au; E++) {
      for (var e = 0, av = this[E][z]; e < av; e++) {
        R += this[E][e]
        e && e != av - 1 && (R += ',')
      }
      E != au - 1 && (R += ' ')
  ...
  function ar(R, i, e) {
    function E() {
      var au = Array[v].splice.call(arguments, 0, arguments[z]),
        av = au[t]('\u25ba')
      E.cache = E.cache || {}
      E.count = E.count || []
      if (av in E.cache) {
        return e ? e(E.cache[av]) : E.cache[av]
      }
      if (E.count[z] >= 1000) {
        delete E.cache[E.count.shift()]
      }
      E.count[ae](av)
      E.cache[av] = R[ao](i, au)
      return e ? e(E.cache[av]) : E.cache[av]
    }
    return E
  }
  l.getRGB = ar(function(e) {
    var az = {
        none: 'none',
        aliceblue: '#f0f8ff',
        amethyst: '#96c',
    ...
    if (aw) {
      if (aw[2]) {
        ay = u(aw[2].substring(5), 16)
        R = u(aw[2].substring(3, 5), 16)
        E = u(aw[2].substring(1, 3), 16)
      }
      if (aw[3]) {
        ay = u(aw[3].substring(3) + aw[3].substring(3), 16)
        R = u(aw[3].substring(2, 3) + aw[3].substring(2, 3), 16)
        E = u(aw[3].substring(1, 2) + aw[3].substring(1, 2), 16)
      }
      if (aw[4]) {
        aw = aw[4][H](/\s*,\s*/)
        E = b(aw[0])
      ...
      av = { r: -1, g: -1, b: -1, hex: 'none', error: 1 }
    }
    return av
  }, l)
  l.getColor = function(i) {
    var E = (this.getColor.start = this.getColor.start || { h: 0, s: 1, b: i || 0.75 }),
      e = this.hsb2rgb(E.h, E.s, E.b)
    E.h += 0.075
    if (E.h > 1) {
      E.h = 0
      E.s -= 0.2
  ...
  l.parsePathString = ar(function(e) {
    if (!e) {
      return null
    }
    var E = { a: 7, c: 6, h: 1, l: 2, m: 2, q: 4, s: 4, t: 2, v: 1, z: 0 },
      i = []
    if (l.is(e, 'array') && l.is(e[0], 'array')) {
      i = D(e)
    }
    if (!i[z]) {
      ;(e + w)[Q](/([achlmqstvz])[\s,]*((-?\d*\.?\d*(?:e[-+]?\d+)?\s*,?\s*)+)/gi, function(
        au,
        R,
        ax
      ) {
        var aw = [],
          av = R.toLowerCase()
        ax[Q](/(-?\d*\.?\d*(?:e[-+]?\d+)?)\s*,?\s*/gi, function(az, ay) {
          ay && aw[ae](+ay)
        })
        while (aw[z] >= E[av]) {
          i[ae]([R][J](aw.splice(0, E[av])))
          if (!E[av]) {
            break
          }
        }
  ...
  var T = ar(function(aA) {
      ...
      for (var au = 0, az = aA[z]; au < az; au++) {
        if (aA[au][0] == 'M') {
          ...
          var av = ab(ax, aw, aA[au][1], aA[au][2], aA[au][3], aA[au][4], aA[au][5], aA[au][6])
          R = R[J](av.min.x, av.max.x)
          E = E[J](av.min.y, av.max.y)
        }
      }
      var e = V[ao](0, R),
        ay = V[ao](0, E)
      return { x: e, y: ay, width: r[ao](0, R) - e, height: r[ao](0, E) - ay }
    }),
    D = function(aw) {
      var R = []
      if (!l.is(aw, 'array') || !l.is(aw && aw[0], 'array')) {
        aw = l.parsePathString(aw)
      }
      for (var E = 0, au = aw[z]; E < au; E++) {
        R[E] = []
        for (var e = 0, av = aw[E][z]; e < av; e++) {
          R[E][e] = aw[E][e]
        }
      }
      R[j] = l._path2string
    ...
    g = ar(
      function(au) {
        if (!l.is(au, 'array') || !l.is(au && au[0], 'array')) {
          au = l.parsePathString(au)
        }
        var aA = [],
          aC = 0,
          aB = 0,
        ...
        for (var ax = R, aG = au[z]; ax < aG; ax++) {
          var e = (aA[ax] = []),
            aD = au[ax]
          if (aD[0] != aD[0].toLowerCase()) {
            e[0] = aD[0].toLowerCase()
            switch (e[0]) {
              case 'a':
                e[1] = aD[1]
                e[2] = aD[2]
                ...
                e[4] = aD[4]
                e[5] = aD[5]
                e[6] = +(aD[6] - aC).toFixed(3)
                e[7] = +(aD[7] - aB).toFixed(3)
                break
              case 'v':
                e[1] = +(aD[1] - aB).toFixed(3)
                break
              case 'm':
                aF = aD[1]
                aE = aD[2]
              default:
                for (var aw = 1, ay = aD[z]; aw < ay; aw++) {
                  e[aw] = +(aD[aw] - (aw % 2 ? aC : aB)).toFixed(3)
                }
            }
          } else {
            e = aA[ax] = []
    ...
    I = ar(
      function(au) {
        ...
        for (var ax = R, aF = au[z]; ax < aF; ax++) {
          var e = (az[ax] = []),
            aC = au[ax]
          if (aC[0] != (aC[0] + w).toUpperCase()) {
            e[0] = (aC[0] + w).toUpperCase()
            switch (e[0]) {
              case 'A':
                e[1] = aC[1]
                e[2] = aC[2]
              ...
              case 'M':
                ...
                aD = +aC[2] + aA
              default:
                for (var aw = 1, ay = aC[z]; aw < ay; aw++) {
                  e[aw] = +aC[aw] + (aw % 2 ? aB : aA)
                }
            }
          } else {
            for (var av = 0, E = aC[z]; av < E; av++) {
              az[ax][av] = aC[av]
            }
          }
          switch (e[0]) {
    ...
    K = function(i, R, aw, au, e, E) {
      var av = 1 / 3,
        az = 2 / 3
      return [av * i + az * aw, av * R + az * au, av * e + az * aw, av * E + az * au, e, E]
    },
    B = function(aF, a9, aO, aM, aG, aA, av, aE, a8, aH) {
      var au = Math.PI,
        aL = (au * 120) / 180,
        e = (au / 180) * (+aG || 0),
        aS = [],
        aP,
        a5 = ar(function(ba, bd, i) {
          var bc = ba * Math.cos(i) - bd * Math.sin(i),
            bb = ba * Math.sin(i) + bd * Math.cos(i)
          return { x: bc, y: bb }
        })
      if (!aH) {
        aP = a5(aF, a9, -e)
        ...
        aE = aP.x
        a8 = aP.y
        var E = Math.cos((au / 180) * aG),
          aC = Math.sin((au / 180) * aG),
          aU = (aF - aE) / 2,
          aT = (a9 - a8) / 2
        aO = r(aO, Math.abs(aU))
        aM = r(aM, Math.abs(aT))
        var R = aO * aO,
          ...
          aZ =
            (aA == av ? -1 : 1) *
            Math.sqrt(
              Math.abs((R * aX - R * aT * aT - aX * aU * aU) / (R * aT * aT + aX * aU * aU))
            ),
          aJ = (aZ * aO * aT) / aM + (aF + aE) / 2,
          aI = (aZ * -aM * aU) / aO + (a9 + a8) / 2,
          az = Math.asin((a9 - aI) / aM),
          ay = Math.asin((a8 - aI) / aM)
        az = aF < aJ ? au - az : az
        ay = aE < aJ ? au - ay : ay
        az < 0 && (az = au * 2 + az)
        ay < 0 && (ay = au * 2 + ay)
      ...
      if (Math.abs(aD) > aL) {
        var aK = ay,
          aN = aE,
          aB = a8
        ay = az + aL * (av && ay > az ? 1 : -1)
        aE = aJ + aO * Math.cos(ay)
        a8 = aI + aM * Math.sin(ay)
        aS = B(aE, a8, aO, aM, aG, 0, av, aN, aB, [ay, aK, aJ, aI])
      }
      aD = ay - az
      var ax = Math.cos(az),
        a7 = Math.sin(az),
        ...
        aW = (4 / 3) * aM * aV,
        a4 = [aF, a9],
        a3 = [aF + aY * a7, a9 - aW * ax],
        a2 = [aE + aY * a6, a8 - aW * aw],
        a0 = [aE, a8]
      a3[0] = 2 * a4[0] - a3[0]
      a3[1] = 2 * a4[1] - a3[1]
      if (aH) {
        return [a3, a2, a0][J](aS)
      } else {
        aS = [a3, a2, a0]
          [J](aS)
          [t](',')
          [H](',')
        var aQ = []
        for (var a1 = 0, aR = aS[z]; a1 < aR; a1++) {
          aQ[a1] = a1 % 2 ? a5(aS[a1 - 1], aS[a1], e).y : a5(aS[a1], aS[a1 + 1], e).x
        }
        return aQ
      }
    },
    O = ar(function(i, e, aK, aI, av, au, az, aw, aE) {
      var aC =
          L(1 - aE, 3) * i +
          L(1 - aE, 2) * 3 * aE * aK +
          (1 - aE) * 3 * aE * aE * av +
        ...
        aA =
          ...
          (1 - aE) * 3 * aE * aE * au +
          L(aE, 3) * aw,
        aG = i + 2 * aE * (aK - i) + aE * aE * (av - 2 * aK + i),
        aF = e + 2 * aE * (aI - e) + aE * aE * (au - 2 * aI + e),
        aJ = aK + 2 * aE * (av - aK) + aE * aE * (az - 2 * av + aK),
        aH = aI + 2 * aE * (au - aI) + aE * aE * (aw - 2 * au + aI),
        aD = (1 - aE) * i + aE * aK,
        aB = (1 - aE) * e + aE * aI,
        R = (1 - aE) * av + aE * az,
        E = (1 - aE) * au + aE * aw
    ...
    ab = ar(function(i, e, R, E, aG, aF, aC, az) {
      var aE = aG - 2 * R + i - (aC - 2 * aG + R),
        aB = 2 * (R - i) - 2 * (aG - R),
        ay = i - R,
        aw = (-aB + Math.sqrt(aB * aB - 4 * aE * ay)) / 2 / aE,
        au = (-aB - Math.sqrt(aB * aB - 4 * aE * ay)) / 2 / aE,
        aA = [e, az],
        aD = [i, aC],
        ax = O(i, e, R, E, aG, aF, aC, az, aw > 0 && aw < 1 ? aw : 0),
        av = O(i, e, R, E, aG, aF, aC, az, au > 0 && au < 1 ? au : 0)
      aD = aD[J](ax.x, av.x)
      aA = aA[J](ax.y, av.y)
      aE = aF - 2 * E + e - (az - 2 * aF + E)
      aB = 2 * (E - e) - 2 * (aF - E)
      ay = e - E
      aw = (-aB + Math.sqrt(aB * aB - 4 * aE * ay)) / 2 / aE
      au = (-aB - Math.sqrt(aB * aB - 4 * aE * ay)) / 2 / aE
      ...
      aA = aA[J](ax.y, av.y)
      return {
        min: { x: V[ao](0, aD), y: V[ao](0, aA) },
        max: { x: r[ao](0, aD), y: r[ao](0, aA) },
      }
    }),
    ag = ar(
      function(aF, aA) {
        var au = I(aF),
          aB = aA && I(aA),
          aC = { x: 0, y: 0, bx: 0, by: 0, X: 0, Y: 0, qx: null, qy: null },
          e = { x: 0, y: 0, bx: 0, by: 0, X: 0, Y: 0, qx: null, qy: null },
          aw = function(aG, aH) {
            var i, aI
            if (!aG) {
              return ['C', aH.x, aH.y, aH.x, aH.y, aH.x, aH.y]
            }
            !(aG[0] in { T: 1, Q: 1 }) && (aH.qx = aH.qy = null)
            switch (aG[0]) {
              case 'M':
                aH.X = aG[1]
                aH.Y = aG[2]
                break
              case 'A':
                aG = ['C'][J](B[ao](0, [aH.x, aH.y][J](aG.slice(1))))
                break
              case 'S':
                i = aH.x + (aH.x - (aH.bx || aH.x))
                aI = aH.y + (aH.y - (aH.by || aH.y))
                aG = ['C', i, aI][J](aG.slice(1))
                break
              case 'T':
                aH.qx = aH.x + (aH.x - (aH.qx || aH.x))
                aH.qy = aH.y + (aH.y - (aH.qy || aH.y))
                aG = ['C'][J](K(aH.x, aH.y, aH.qx, aH.qy, aG[1], aG[2]))
                break
              case 'Q':
                aH.qx = aG[1]
                aH.qy = aG[2]
                aG = ['C'][J](K(aH.x, aH.y, aG[1], aG[2], aG[3], aG[4]))
                break
              case 'L':
                aG = ['C'][J](k(aH.x, aH.y, aG[1], aG[2]))
                break
              case 'H':
                aG = ['C'][J](k(aH.x, aH.y, aG[1], aH.y))
                break
              case 'V':
                aG = ['C'][J](k(aH.x, aH.y, aH.x, aG[1]))
                break
              case 'Z':
                aG = ['C'][J](k(aH.x, aH.y, aH.X, aH.Y))
                break
            }
            return aG
          },
          E = function(aG, aH) {
            if (aG[aH][z] > 7) {
              ...
              var aI = aG[aH]
              while (aI[z]) {
                aG.splice(aH++, 0, ['C'][J](aI.splice(0, 6)))
              }
              aG.splice(aH, 1)
              aD = r(au[z], (aB && aB[z]) || 0)
            }
          },
          R = function(aK, aJ, aH, aG, aI) {
            if (aK && aJ && aK[aI][0] == 'M' && aJ[aI][0] != 'M') {
              aJ.splice(aI, 0, ['M', aG.x, aG.y])
              aH.bx = 0
              aH.by = 0
              aH.x = aK[aI][1]
              aH.y = aK[aI][2]
        ...
        for (var ay = 0, aD = r(au[z], (aB && aB[z]) || 0); ay < aD; ay++) {
          au[ay] = aw(au[ay], aC)
          E(au, ay)
          aB && (aB[ay] = aw(aB[ay], e))
          aB && E(aB, ay)
          ...
          aC.x = ax[av - 2]
          aC.y = ax[av - 1]
          aC.bx = b(ax[av - 4]) || aC.x
          aC.by = b(ax[av - 3]) || aC.y
          e.bx = aB && (b(aE[az - 4]) || e.x)
          e.by = aB && (b(aE[az - 3]) || e.y)
          e.x = aB && aE[az - 2]
          e.y = aB && aE[az - 1]
        }
        return aB ? [au, aB] : au
    ...
    x = ar(function(az) {
      var ay = []
      for (var av = 0, aA = az[z]; av < aA; av++) {
        var e = {},
          ax = az[av].match(/^([^:]*):?([\d\.]*)/)
        e.color = l.getRGB(ax[1])
        if (e.color.error) {
          return null
        }
        e.color = e.color.hex
      ...
      for (var av = 1, aA = ay[z] - 1; av < aA; av++) {
        if (!ay[av].offset) {
          var E = b(ay[av - 1].offset || 0),
            R = 0
          for (var au = av + 1; au < aA; au++) {
            if (ay[au].offset) {
              R = ay[au].offset
              break
            }
    ...
    X = function() {
      var E, i, au, R, e
      if (l.is(arguments[0], 'string') || l.is(arguments[0], 'object')) {
        if (l.is(arguments[0], 'string')) {
          E = m.getElementById(arguments[0])
        } else {
          E = arguments[0]
        }
        if (E.tagName) {
          if (arguments[1] == null) {
            ...
            return { container: E, width: arguments[1], height: arguments[2] }
          }
        }
      } else {
        if (l.is(arguments[0], ah) && arguments[z] > 3) {
          return {
            container: 1,
            x: arguments[0],
            y: arguments[1],
  ...
  if (l.svg) {
    ...
    var N = function(av) {
      for (var E = 0, R = av[z]; E < R; E++) {
        if (av[E][0].toLowerCase() != 'a') {
          for (var e = 1, au = av[E][z]; e < au; e++) {
            av[E][e] = ai(av[E][e])
          }
        } else {
          av[E][6] = ai(av[E][6])
    ...
    var P = function(E, e) {
      if (e) {
        ...
        return m.createElementNS(d.svgns, E)
      }
    }
    l[j] = function() {
    ...
    var aq = function(e, R) {
      var i = P('path')
      R.canvas && R.canvas[c](i)
      var E = new s(i, R)
      E.type = 'path'
      W(E, { fill: 'none', stroke: '#000', path: e })
      return E
    }
    var af = function(R, aD, e) {
      var aA = 'linear',
        ax = 0.5,
        av = 0.5,
        aF = R.style
      aD = (aD + w)[Q](/^r(?:\(([^,]+?)\s*,\s*([^\)]+?)\))?/, function(aG, i, aH) {
        aA = 'radial'
        if (i && aH) {
          ax = b(i)
          av = b(aH)
          if (L(ax - 0.5, 2) + L(av - 0.5, 2) > 0.25) {
            av = Math.sqrt(0.25 - L(ax - 0.5, 2)) + 0.5
          }
        }
        return w
      })
      ...
      if (aA == 'linear') {
        ...
        var au = [0, 0, Math.cos((aw * Math.PI) / 180), Math.sin((aw * Math.PI) / 180)],
          aC = 1 / (r(Math.abs(au[2]), Math.abs(au[3])) || 1)
        au[2] *= aC
        au[3] *= aC
        if (au[2] < 0) {
          au[0] = -au[2]
      ...
      var E = P(aA + 'Gradient')
      E.id = 'r' + (l.idGenerator++)[j](36)
      aA == 'radial'
        ? P(E, { fx: ax, fy: av })
        : P(E, { x1: au[0], y1: au[1], x2: au[2], y2: au[3] })
      e.defs[c](E)
      for (var ay = 0, aE = az[z]; ay < aE; ay++) {
        var aB = P('stop')
        P(aB, {
      ...
      P(R, { fill: 'url(#' + E.id + ')', opacity: 1, 'fill-opacity': 1 })
      aF.fill = w
      aF.opacity = 1
      aF.fillOpacity = 1
      return 1
    ...
    var C = function(i) {
      var e = i.getBBox()
      P(i.pattern, { patternTransform: l.format('translate({0},{1})', e.x, e.y) })
    }
    var W = function(aB, aK) {
      var aE = {
          '': [0],
          none: [0],
          '-': [3, 1],
        ...
        ay = aB.attr('rotation'),
        av = function(aR, aQ) {
          aQ = aE[(aQ + w).toLowerCase()]
          if (aQ) {
            var aO = aR.attrs['stroke-width'] || '1',
              aM =
                { round: aO, square: aO, butt: 0 }[
                  aR.attrs['stroke-linecap'] || aK['stroke-linecap']
                ] || 0,
              aP = []
            var aN = aQ[z]
            while (aN--) {
              aP[aN] = aQ[aN] * aO + (aN % 2 ? 1 : -1) * aM
            }
            P(aG, { 'stroke-dasharray': aP[t](',') })
          }
        }
      b(ay) && aB.rotate(0, true)
      for (var aF in aK) {
        if (aK[h](aF)) {
          if (!(aF in A)) {
            continue
          ...
          switch (aF) {
            ...
            case 'target':
              ...
              if (aI.tagName.toLowerCase() != 'a') {
                var R = P('a')
                aI.insertBefore(R, aG)
                R[c](aG)
                aI = R
              }
              aI.setAttributeNS(aB.paper.xlink, aF, aD)
              break
            case 'clip-rect':
              var i = (aD + w)[H](at)
              if (i[z] == 4) {
                aB.clip && aB.clip.parentNode.parentNode.removeChild(aB.clip.parentNode)
                var E = P('clipPath'),
                  aH = P('rect')
                E.id = 'r' + (l.idGenerator++)[j](36)
                P(aH, { x: i[0], y: i[1], width: i[2], height: i[3] })
                E[c](aH)
                aB.paper.defs[c](E)
                P(aG, { 'clip-path': 'url(#' + E.id + ')' })
                aB.clip = aH
              }
              if (!aD) {
                var aJ = m.getElementById(aG.getAttribute('clip-path')[Q](/(^url\(#|\)$)/g, w))
            ...
            case 'src':
              if (aB.type == 'image') {
                aG.setAttributeNS(aB.paper.xlink, 'href', aD)
              }
              break
            case 'stroke-width':
              aG.style.strokeWidth = aD
              aG[f](aF, aD)
              if (aC['stroke-dasharray']) {
                av(aB, aC['stroke-dasharray'])
              }
              break
            ...
            case 'translation':
              var aw = (aD + w)[H](at)
              aB.translate((+aw[0] + 1 || 2) - 1, (+aw[1] + 1 || 2) - 1)
              break
            case 'scale':
              var aw = (aD + w)[H](at)
              aB.scale(+aw[0] || 1, +aw[1] || +aw[0] || 1, +aw[2] || null, +aw[3] || null)
              break
            case 'fill':
              var au = (aD + w).match(/^url\(['"]?([^\)]+)['"]?\)$/i)
              if (au) {
                var E = P('pattern'),
                  aA = P('image')
                E.id = 'r' + (l.idGenerator++)[j](36)
                P(E, { x: 0, y: 0, patternUnits: 'userSpaceOnUse' })
                P(aA, { x: 0, y: 0 })
                aA.setAttributeNS(aB.paper.xlink, 'href', au[1])
                E[c](aA)
                var aL = m.createElement('img')
                aL.style.cssText = 'position:absolute;left:-9999em;top-9999em'
                aL.onload = function() {
                  P(E, { width: this.offsetWidth, height: this.offsetHeight })
                  P(aA, { width: this.offsetWidth, height: this.offsetHeight })
                  m.body.removeChild(this)
                  d.safari()
                }
                m.body[c](aL)
                aL.src = au[1]
                aB.paper.defs[c](E)
                aG.style.fill = 'url(#' + E.id + ')'
                P(aG, { fill: 'url(#' + E.id + ')' })
                aB.pattern = E
                aB.pattern && C(aB)
                break
              }
              if (!l.getRGB(aD).error) {
                delete aK.gradient
                delete aC.gradient
                if (!l.is(aC.opacity, 'undefined') && l.is(aK.opacity, 'undefined')) {
                  aG.style.opacity = aC.opacity
                  P(aG, { opacity: aC.opacity })
                }
                if (
                  !l.is(aC['fill-opacity'], 'undefined') &&
                  l.is(aK['fill-opacity'], 'undefined')
                ) {
                  aG.style.fillOpacity = aC['fill-opacity']
                  P(aG, { 'fill-opacity': aC['fill-opacity'] })
                }
              } else {
                if (
                  (aB.type in { circle: 1, ellipse: 1 } || (aD + w).charAt(0) != 'r') &&
                  af(aG, aD, aB.paper)
                ) {
                  aC.gradient = aD
                  aC.fill = 'none'
            ...
            case 'stroke':
              aG.style[aF] = l.getRGB(aD).hex
              aG[f](aF, l.getRGB(aD).hex)
              break
            case 'gradient':
              ;(aB.type in { circle: 1, ellipse: 1 } || (aD + w).charAt(0) != 'r') &&
                af(aG, aD, aB.paper)
            ...
            case 'fill-opacity':
              if (aC.gradient) {
                var e = m.getElementById(aG.getAttribute('fill')[Q](/^url\(#|\)$/g, w))
                if (e) {
                  var ax = e.getElementsByTagName('stop')
                  ax[ax[z] - 1][f]('stop-opacity', aD)
                }
                break
              }
            default:
              aF == 'font-size' && (aD = u(aD, 10) + 'px')
              var az = aF[Q](/(\-.)/g, function(aM) {
      ...
      am(aB, aK)
      u(ay, 10) && aB.rotate(ay, true)
    }
    var ac = 1.2
    var am = function(e, au) {
      if (
        e.type != 'text' ||
        !('text' in au || 'font' in au || 'font-size' in au || 'x' in au || 'y' in au)
      ) {
        return
      }
      var az = e.attrs,
        E = e.node,
        aB = E.firstChild
          ? u(m.defaultView.getComputedStyle(E.firstChild, w).getPropertyValue('font-size'), 10)
          : 10
      if ('text' in au) {
        while (E.firstChild) {
        ...
        var R = (au.text + w)[H]('\n')
        for (var av = 0, aA = R[z]; av < aA; av++) {
          var ax = P('tspan')
          av && P(ax, { dy: aB * ac, x: az.x })
          ax[c](m.createTextNode(R[av]))
          E[c](ax)
        }
      } else {
        var R = E.getElementsByTagName('tspan')
        for (var av = 0, aA = R[z]; av < aA; av++) {
          av && P(R[av], { dy: aB * ac, x: az.x })
        }
      }
      P(E, { y: az.y })
      var aw = e.getBBox(),
    ...
    s[v].rotate = function(i, e, R) {
      if (i == null) {
        if (this._.rt.cx) {
          return [this._.rt.deg, this._.rt.cx, this._.rt.cy][t](' ')
        }
      ...
      if (this._.rt.deg) {
        this.transformations[0] = l.format('rotate({0} {1} {2})', this._.rt.deg, e, R)
        this.clip &&
          P(this.clip, { transform: l.format('rotate({0} {1} {2})', -this._.rt.deg, e, R) })
      } else {
        this.transformations[0] = w
        this.clip && P(this.clip, { transform: w })
      }
      P(this.node, { transform: this.transformations[t](' ') })
      return this
    }
    s[v].hide = function() {
    ...
    s[v].getBBox = function() {
      if (this.type == 'path') {
        return T(this.attrs.path)
      }
      ...
      if (this.type == 'text') {
        ...
        for (var E = 0, au = this.node.getNumberOfChars(); E < au; E++) {
          var aw = this.node.getExtentOfChar(E)
          aw.y < ax.y && (ax.y = aw.y)
    ...
    s[v].attr = function() {
      if (arguments[z] == 1 && l.is(arguments[0], 'string')) {
      ...
      if (arguments[z] == 1 && l.is(arguments[0], 'array')) {
        var e = {}
      ...
      if (arguments[z] == 2) {
        ...
        if (arguments[z] == 1 && l.is(arguments[0], 'object')) {
          W(this, arguments[0])
        }
      }
      return this
    }
    s[v].toFront = function() {
      this.node.parentNode[c](this.node)
      return this
    }
    s[v].toBack = function() {
    ...
    s[v].insertAfter = function(e) {
      if (e.node.nextSibling) {
        e.node.parentNode.insertBefore(this.node, e.node.nextSibling)
      } else {
        e.node.parentNode[c](this.node)
      }
      return this
    }
    s[v].insertBefore = function(e) {
      var i = e.node
      i.parentNode.insertBefore(this.node, i)
      return this
    }
    var S = function(i, e, av, au) {
      e = ai(e)
      av = ai(av)
      var R = P('circle')
      i.canvas && i.canvas[c](R)
      var E = new s(R, i)
      E.attrs = { cx: e, cy: av, r: au, fill: 'none', stroke: '#000' }
      E.type = 'circle'
      P(R, E.attrs)
      return E
    }
    var aa = function(E, e, ax, i, av, aw) {
      e = ai(e)
      ax = ai(ax)
      var au = P('rect')
      E.canvas && E.canvas[c](au)
      var R = new s(au, E)
      R.attrs = {
        x: e,
        y: ax,
    ...
    var n = function(i, e, aw, av, au) {
      e = ai(e)
      aw = ai(aw)
      var R = P('ellipse')
      i.canvas && i.canvas[c](R)
      var E = new s(R, i)
      E.attrs = { cx: e, cy: aw, rx: av, ry: au, fill: 'none', stroke: '#000' }
      E.type = 'ellipse'
      P(R, E.attrs)
      return E
    }
    var y = function(E, aw, e, ax, i, av) {
      var au = P('image')
      P(au, { x: e, y: ax, width: i, height: av, preserveAspectRatio: 'none' })
      au.setAttributeNS(E.xlink, 'href', aw)
      E.canvas && E.canvas[c](au)
      var R = new s(au, E)
      R.attrs = { x: e, y: ax, width: i, height: av, src: aw }
      R.type = 'image'
      return R
    }
    var Z = function(i, e, av, au) {
      var R = P('text')
      P(R, { x: e, y: av, 'text-anchor': 'middle' })
      i.canvas && i.canvas[c](R)
      var E = new s(R, i)
      E.attrs = {
        x: e,
    ...
    var q = function() {
      ...
      d.height = e || 342
      aw[f]('width', d.width)
      aw[f]('height', d.height)
      if (E == 1) {
        aw.style.cssText = 'position:absolute;left:' + i + 'px;top:' + ax + 'px'
        m.body[c](aw)
      } else {
        if (E.firstChild) {
          E.insertBefore(aw, E.firstChild)
        } else {
          E[c](aw)
        }
      }
    ...
    d.clear = function() {
      ...
      ;(this.desc = P('desc'))[c](m.createTextNode('Created with Rapha\u00ebl'))
      e[c](this.desc)
      e[c]((this.defs = P('defs')))
    }
    d.remove = function() {
  ...
  if (l.vml) {
    var M = function(aE) {
      ...
      ;(aE + w).match(aB) && (aw = ag)
      aB = /[clmz]/g
      if (aw == I && !(aE + w).match(aB)) {
        var E = { M: 'm', L: 'l', C: 'c', Z: 'x', m: 't', l: 'r', c: 'v', z: 'x' },
          au = /([clmz]),?([^clmz]*)/gi,
          av = /-?[^,\s-]+/g
        var aA = (aE + w)[Q](au, function(aF, aH, i) {
          var aG = []
          i[Q](av, function(aI) {
            aG[ae](ai(aI))
          })
      ...
      var aC = aw(aE),
        ...
        aA = [],
        e
      for (var ay = 0, aD = aC[z]; ay < aD; ay++) {
        R = aC[ay]
        e = (aC[ay][0] + w).toLowerCase()
        e == 'z' && (e = 'x')
        for (var ax = 1, az = R[z]; ax < az; ax++) {
          e += ai(R[ax]) + (ax != az - 1 ? ',' : w)
        }
        aA[ae](e)
      }
    ...
    var aq = function(e, av) {
      var R = ap('group')
      R.style.cssText =
        'position:absolute;left:0;top:0;width:' + av.width + 'px;height:' + av.height + 'px'
      R.coordsize = av.coordsize
      R.coordorigin = av.coordorigin
      var E = ap('shape'),
        i = E.style
      i.width = av.width + 'px'
      i.height = av.height + 'px'
      ...
      au.path = []
      au.Path = w
      e && W(au, { fill: 'none', stroke: '#000', path: e })
      av.canvas[c](R)
      return au
    }
    var W = function(az, aD) {
      az.attrs = az.attrs || {}
      var aB = az.node,
        aE = az.attrs,
        aw = aB.style,
      ...
      aD.href && (aB.href = aD.href)
      aD.title && (aB.title = aD.title)
      aD.target && (aB.target = aD.target)
      if (aD.path && az.type == 'path') {
        aE.path = aD.path
        aB.path = M(aE.path)
      }
      if (aD.rotation != null) {
        az.rotate(aD.rotation, true)
      }
      if (aD.translation) {
        R = (aD.translation + w)[H](at)
        az.translate(R[0], R[1])
      }
      if (aD.scale) {
        R = (aD.scale + w)[H](at)
        az.scale(+R[0] || 1, +R[1] || +R[0] || 1, +R[2] || null, +R[3] || null)
      }
      if ('clip-rect' in aD) {
        var e = (aD['clip-rect'] + w)[H](at)
        if (e[z] == 4) {
          e[2] = +e[2] + +e[0]
          e[3] = +e[3] + +e[1]
          var ay = aB.clipRect || m.createElement('div'),
            aH = ay.style,
            av = aB.parentNode
          aH.clip = l.format('rect({1}px {2}px {3}px {0}px)', e)
          if (!aB.clipRect) {
            aH.position = 'absolute'
            aH.top = 0
            aH.left = 0
            aH.width = az.paper.width + 'px'
            aH.height = az.paper.height + 'px'
        ...
        if (!aD['clip-rect']) {
          aB.clipRect && (aB.clipRect.style.clip = w)
        }
      }
      if (az.type == 'image' && aD.src) {
        aB.src = aD.src
      }
      if (az.type == 'image' && aD.opacity) {
        aB.filterOpacity =
          ' progid:DXImageTransform.Microsoft.Alpha(opacity=' + aD.opacity * 100 + ')'
        aw.filter = (aB.filterMatrix || w) + (aB.filterOpacity || w)
      }
      aD.font && (aw.font = aD.font)
      aD['font-family'] &&
        (aw.fontFamily = '"' + aD['font-family'][H](',')[0][Q](/^['"]+|['"]+$/g, w) + '"')
      aD['font-size'] && (aw.fontSize = aD['font-size'])
      aD['font-weight'] && (aw.fontWeight = aD['font-weight'])
      aD['font-style'] && (aw.fontStyle = aD['font-style'])
      if (
        aD.opacity != null ||
        aD['stroke-width'] != null ||
        aD.fill != null ||
        aD.stroke != null ||
        aD['stroke-width'] != null ||
        aD['stroke-opacity'] != null ||
        aD['fill-opacity'] != null ||
        aD['stroke-dasharray'] != null ||
        aD['stroke-miterlimit'] != null ||
        aD['stroke-linejoin'] != null ||
        aD['stroke-linecap'] != null
      ) {
        aB = az.shape || aB
        var aC = aB.getElementsByTagName('fill') && aB.getElementsByTagName('fill')[0],
          aF = false
        !aC && (aF = aC = ap('fill'))
        if ('fill-opacity' in aD || 'opacity' in aD) {
          var i = ((+aE['fill-opacity'] + 1 || 2) - 1) * ((+aE.opacity + 1 || 2) - 1)
          i < 0 && (i = 0)
          i > 1 && (i = 1)
          aC.opacity = i
        }
        aD.fill && (aC.on = true)
        if (aC.on == null || aD.fill == 'none') {
          aC.on = false
        }
        if (aC.on && aD.fill) {
          var E = aD.fill.match(/^url\(([^\)]+)\)$/i)
          if (E) {
            aC.src = E[1]
            aC.type = 'tile'
          } else {
            aC.color = l.getRGB(aD.fill).hex
            aC.src = w
            aC.type = 'solid'
            if (
              l.getRGB(aD.fill).error &&
              (aI.type in { circle: 1, ellipse: 1 } || (aD.fill + w).charAt(0) != 'r') &&
              af(aI, aD.fill)
            ) {
              aE.fill = 'none'
              aE.gradient = aD.fill
        ...
        aF && aB[c](aC)
        var au = aB.getElementsByTagName('stroke') && aB.getElementsByTagName('stroke')[0],
          aG = false
        !au && (aG = au = ap('stroke'))
        if (
          (aD.stroke && aD.stroke != 'none') ||
          aD['stroke-width'] ||
          aD['stroke-opacity'] != null ||
          aD['stroke-dasharray'] ||
          aD['stroke-miterlimit'] ||
          aD['stroke-linejoin'] ||
          aD['stroke-linecap']
        ) {
          au.on = true
        }
        ;(aD.stroke == 'none' || au.on == null || aD.stroke == 0 || aD['stroke-width'] == 0) &&
          (au.on = false)
        au.on && aD.stroke && (au.color = l.getRGB(aD.stroke).hex)
        var i = ((+aE['stroke-opacity'] + 1 || 2) - 1) * ((+aE.opacity + 1 || 2) - 1)
        i < 0 && (i = 0)
        i > 1 && (i = 1)
        au.opacity = i
        aD['stroke-linejoin'] && (au.joinstyle = aD['stroke-linejoin'] || 'miter')
        au.miterlimit = aD['stroke-miterlimit'] || 8
        aD['stroke-linecap'] &&
          (au.endcap =
            { butt: 'flat', square: 'square', round: 'round' }[aD['stroke-linecap']] || 'miter')
        aD['stroke-width'] && (au.weight = ((b(aD['stroke-width']) || 1) * 12) / 16)
        if (aD['stroke-dasharray']) {
          var aA = {
            '-': 'shortdash',
            '.': 'shortdot',
            '-.': 'shortdashdot',
          ...
          au.dashstyle = aA[aD['stroke-dasharray']] || w
        }
        aG && aB[c](au)
      }
      if (aI.type == 'text') {
        var aw = aI.paper.span.style
        aE.font && (aw.font = aE.font)
        aE['font-family'] && (aw.fontFamily = aE['font-family'])
        aE['font-size'] && (aw.fontSize = aE['font-size'])
        aE['font-weight'] && (aw.fontWeight = aE['font-weight'])
        aE['font-style'] && (aw.fontStyle = aE['font-style'])
        aI.node.string &&
          (aI.paper.span.innerHTML = (aI.node.string + w)
            [Q](/</g, '&#60;')
            [Q](/&/g, '&#38;')
            [Q](/\n/g, '<br>'))
        aI.W = aE.w = aI.paper.span.offsetWidth
        aI.H = aE.h = aI.paper.span.offsetHeight
        aI.X = aE.x
        aI.Y = aE.y + ai(aI.H / 2)
        switch (aE['text-anchor']) {
          case 'start':
            aI.node.style['v-text-align'] = 'left'
            aI.bbx = ai(aI.W / 2)
            break
          case 'end':
            aI.node.style['v-text-align'] = 'right'
            aI.bbx = -ai(aI.W / 2)
            break
          default:
            aI.node.style['v-text-align'] = 'center'
            break
        }
      }
    }
    var af = function(e, ax) {
      e.attrs = e.attrs || {}
      var ay = e.attrs,
        aA = e.node.getElementsByTagName('fill'),
        av = 'linear',
        aw = '.5 .5'
      e.attrs.gradient = ax
      ax = (ax + w)[Q](/^r(?:\(([^,]+?)\s*,\s*([^\)]+?)\))?/, function(aC, aD, i) {
        av = 'radial'
        if (aD && i) {
          aD = b(aD)
          i = b(i)
          if (L(aD - 0.5, 2) + L(i - 0.5, 2) > 0.25) {
            i = Math.sqrt(0.25 - L(aD - 0.5, 2)) + 0.5
          }
          aw = aD + ' ' + i
        }
        return w
      ...
      if (au[z]) {
        aA.on = true
        aA.method = 'none'
        aA.type = av == 'radial' ? 'gradientradial' : 'gradient'
        aA.color = au[0].color
        aA.color2 = au[au[z] - 1].color
        var aB = []
        for (var R = 0, az = au[z]; R < az; R++) {
          au[R].offset && aB[ae](au[R].offset + ' ' + au[R].color)
        }
        if (aB[z] && aA.colors) {
          aA.colors.value = aB[t](',')
        } else {
          aA.colors.value = '0% ' + aA.color
        }
        if (av == 'radial') {
          aA.focus = '100%'
          aA.focussize = aw
    ...
    s[v].setBox = function(av, aw, au) {
      var E = this.Group.style,
        ax = (this.shape && this.shape.style) || this.node.style
      av = av || {}
      for (var ay in av) {
        if (av[h](ay)) {
          this.attrs[ay] = av[ay]
      ...
      switch (this.type) {
        ...
        case 'path':
          if (!this.attrs.path) {
            ...
            aD = 0
            aF = this.paper.width
            aA = this.paper.height
          } else {
            var az = T(this.attrs.path)
            aE = az.x
            aD = az.y
            aF = az.width
            aA = az.height
      ...
      aw = aw == null ? aE + aF / 2 : aw
      au = au == null ? aD + aA / 2 : au
      var R = aw - this.paper.width / 2,
        aC = au - this.paper.height / 2
      if (this.type == 'path' || this.type == 'text') {
        E.left != R + 'px' && (E.left = R + 'px')
        E.top != aC + 'px' && (E.top = aC + 'px')
        this.X = this.type == 'text' ? aE : -R
        this.Y = this.type == 'text' ? aD : -aC
        this.W = aF
        this.H = aA
        ax.left != -R + 'px' && (ax.left = -R + 'px')
        ax.top != -aC + 'px' && (ax.top = -aC + 'px')
      } else {
        E.left != R + 'px' && (E.left = R + 'px')
        E.top != aC + 'px' && (E.top = aC + 'px')
        this.X = aE
        ...
        ax.left != aE - R + 'px' && (ax.left = aE - R + 'px')
        ax.top != aD - aC + 'px' && (ax.top = aD - aC + 'px')
        ax.width != aF + 'px' && (ax.width = aF + 'px')
        ax.height != aA + 'px' && (ax.height = aA + 'px')
        var aG = (+av.r || 0) / V(aF, aA)
        if (this.type == 'rect' && this.arcsize != aG && (aG || this.arcsize)) {
          var e = ap(aG ? 'roundrect' : 'rect')
          e.arcsize = aG
          this.Group[c](e)
          this.node.parentNode.removeChild(this.node)
          this.node = e
    ...
    s[v].attr = function() {
      ...
      if (this.attrs && arguments[z] == 1 && l.is(arguments[0], 'array')) {
        var e = {}
        for (var E = 0, R = arguments[0][z]; E < R; E++) {
          e[arguments[0][E]] = this.attrs[arguments[0][E]]
        }
        return e
      }
      var au
      ...
      if (au) {
        if (
          au.gradient &&
          (this.type in { circle: 1, ellipse: 1 } || (au.gradient + w).charAt(0) != 'r')
        ) {
          af(this, au.gradient)
        }
        if (au.text && this.type == 'text') {
          this.node.string = au.text
        }
        W(this, au)
        this.setBox(this.attrs)
      }
    ...
    s[v].toFront = function() {
      this.Group.parentNode[c](this.Group)
      return this
    }
    s[v].toBack = function() {
    ...
    s[v].insertAfter = function(e) {
      if (e.Group.nextSibling) {
        ...
        e.Group.parentNode[c](this.Group)
      }
      return this
    }
    s[v].insertBefore = function(e) {
    ...
    var S = function(i, e, ax, av) {
      var au = ap('group'),
        aw = ap('oval'),
        E = aw.style
      au.style.cssText =
        'position:absolute;left:0;top:0;width:' + i.width + 'px;height:' + i.height + 'px'
      au.coordsize = i.coordsize
      au.coordorigin = i.coordorigin
      au[c](aw)
      var R = new s(aw, au, i)
      R.type = 'circle'
      W(R, { stroke: '#000', fill: 'none' })
      R.attrs.cx = e
      R.attrs.cy = ax
      R.attrs.r = av
      R.setBox({ x: e - av, y: ax - av, width: av * 2, height: av * 2 })
      i.canvas[c](au)
      return R
    }
    var aa = function(i, ax, aw, ay, R, e) {
      var au = ap('group'),
        E = ap(e ? 'roundrect' : 'rect'),
        az = (+e || 0) / V(ay, R)
      E.arcsize = az
      au.style.cssText =
        'position:absolute;left:0;top:0;width:' + i.width + 'px;height:' + i.height + 'px'
      ...
      W(av, { stroke: '#000' })
      av.arcsize = az
      av.setBox({ x: ax, y: aw, width: ay, height: R, r: +e })
      i.canvas[c](au)
      return av
    }
    var n = function(e, ay, ax, E, i) {
      var au = ap('group'),
        R = ap('oval'),
        aw = R.style
      au.style.cssText =
        'position:absolute;left:0;top:0;width:' + e.width + 'px;height:' + e.height + 'px'
      au.coordsize = e.coordsize
      au.coordorigin = e.coordorigin
      au[c](R)
      var av = new s(R, au, e)
      av.type = 'ellipse'
      W(av, { stroke: '#000' })
      ...
      av.attrs.rx = E
      av.attrs.ry = i
      av.setBox({ x: ay - E, y: ax - i, width: E * 2, height: i * 2 })
      e.canvas[c](au)
      return av
    }
    var y = function(i, e, ay, ax, az, R) {
      var au = ap('group'),
        E = ap('image'),
        aw = E.style
      au.style.cssText =
      ...
      av.attrs.w = az
      av.attrs.h = R
      av.setBox({ x: ay, y: ax, width: az, height: R })
      i.canvas[c](au)
      return av
    }
    var Z = function(i, ay, ax, az) {
      var au = ap('group'),
        R = ap('shape'),
        aw = R.style,
        aA = ap('path'),
      ...
      au.coordsize = i.coordsize
      au.coordorigin = i.coordorigin
      aA.v = l.format('m{0},{1}l{2},{1}', ai(ay), ai(ax), ai(ay) + 1)
      aA.textpathok = true
      aw.width = i.width
      aw.height = i.height
      E.string = az
      ...
      av.attrs.w = 1
      av.attrs.h = 1
      W(av, { font: A.font, stroke: 'none', fill: '#000' })
      av.setBox()
      i.canvas[c](au)
      return av
    }
    var U = function(E, e) {
      ...
      this.width = b(E || this.width)
      this.height = b(e || this.height)
    ...
    try {
      !m.namespaces.rvml && m.namespaces.add('rvml', 'urn:schemas-microsoft-com:vml')
      var ap = function(e) {
        return m.createElement('<rvml:' + e + ' class="rvml">')
      }
    } catch (an) {
      var ap = function(e) {
        return m.createElement('<' + e + ' xmlns="urn:schemas-microsoft.com:vml" class="rvml">')
      }
    }
    var q = function() {
      var R = X[ao](null, arguments),
      ...
      var av = {},
        aw = (av.canvas = m.createElement('div')),
        au = aw.style
      E = b(E) || 512
      az = b(az) || 342
      av.width = E
      ...
      av.coordsize = E + ' ' + az
      av.coordorigin = '0 0'
      av.span = m.createElement('span')
      av.span.style.cssText =
        'position:absolute;left:-9999px;top:-9999px;padding:0;margin:0;line-height:1;display:inline;'
      aw[c](av.span)
      au.cssText = l.format(
        'width:{0}px;height:{1}px;position:absolute;clip:rect(0 {0}px {1}px 0)',
        E,
        az
      )
      if (i == 1) {
        ...
        au.left = ay + 'px'
        au.top = ax + 'px'
        i = { style: { width: E, height: az } }
      } else {
        i.style.width = E
        i.style.height = az
        if (i.firstChild) {
          i.insertBefore(aw, i.firstChild)
        } else {
          i[c](aw)
        }
      }
  ...
  var o = (function() {
    if (m.addEventListener) {
      return function(au, E, i, e) {
        var R = function(av) {
          return i.call(e, av)
        }
        au.addEventListener(E, R, false)
        return function() {
          au.removeEventListener(E, R, false)
          return true
        }
      }
    } else {
      if (m.attachEvent) {
        return function(av, R, E, i) {
          var au = function(aw) {
            return E.call(i, aw || ad.event)
          }
          av.attachEvent('on' + R, au)
          var e = function() {
            av.detachEvent('on' + R, au)
            return true
          }
          if (R == 'mouseover') {
            av.attachEvent('onmouseenter', au)
            return function() {
              av.detachEvent('onmouseenter', au)
              return e()
            }
          } else {
            if (R == 'mouseout') {
              av.attachEvent('onmouseleave', au)
              return function() {
                av.detachEvent('onmouseleave', au)
                return e()
              }
            }
          }
    ...
    ;(function(e) {
      s[v][e] = function(i) {
        if (l.is(i, 'function')) {
          ...
          this.events[e][i][ae](o(this.shape || this.node, e, i, this))
        }
        return this
      }
      s[v]['un' + e] = function(i) {
        this.events &&
          ...
          this.events[e][i] &&
          this.events[e][i][z] &&
          this.events[e][i].shift()() &&
          !this.events[e][i][z] &&
          delete this.events[e][i]
      }
    })(G[ak])
  }
  d.circle = function(e, E, i) {
    return S(this, e || 0, E || 0, i || 0)
  }
  d.rect = function(e, au, i, E, R) {
    return aa(this, e || 0, au || 0, i || 0, E || 0, R || 0)
  }
  d.ellipse = function(e, R, E, i) {
    return n(this, e || 0, R || 0, E || 0, i || 0)
  }
  d.path = function(e) {
    e && !l.is(e, 'string') && !l.is(e[0], 'array') && (e += w)
    return aq(l.format[ao](l, arguments), this)
  }
  d.image = function(R, e, au, i, E) {
    return y(this, R || 'about:blank', e || 0, au || 0, i || 0, E || 0)
  }
  d.text = function(e, E, i) {
    return Z(this, e || 0, E || 0, i || w)
  }
  d.set = function(e) {
    arguments[z] > 1 && (e = Array[v].splice.call(arguments, 0, arguments[z]))
    return new p(e)
  }
  d.setSize = U
  s[v].stop = function() {
  ...
  s[v].scale = function(aE, aD, R, E) {
    ...
    if (aE != 0) {
      ...
      switch (this.type) {
        case 'rect':
        case 'image':
          var az = aU.width * aA * aT,
            aK = aU.height * ax * aS,
            aC = aU.r * V(aT, aS),
            aw = aW - az / 2,
            au = aV - aK / 2
          this.attr({ width: az, height: aK, x: aw, y: au, r: aC })
          break
        case 'circle':
        case 'ellipse':
          this.attr({ rx: aU.rx * aT, ry: aU.ry * aS, r: aU.r * V(aT, aS), cx: aW, cy: aV })
          break
        case 'path':
          var aN = g(aU.path),
            aO = true
          for (var aQ = 0, aJ = aN[z]; aQ < aJ; aQ++) {
            var aM = aN[aQ]
            if (aM[0].toUpperCase() == 'M' && aO) {
              continue
            } else {
              aO = false
            }
            if (l.svg && aM[0].toUpperCase() == 'A') {
              aM[aN[aQ][z] - 2] *= aT
              aM[aN[aQ][z] - 1] *= aS
              aM[1] *= aT
              aM[2] *= aS
              aM[5] = +(aA + ax ? !!+aM[5] : !+aM[5])
            } else {
              for (var aP = 1, aR = aM[z]; aP < aR; aP++) {
                aM[aP] *= aP % 2 ? aT : aS
              }
            }
          }
          var e = T(aN),
            aI = aW - e.x - e.width / 2,
            aG = aV - e.y - e.height / 2
          aN[0][1] += aI
          aN[0][2] += aG
          this.attr({ path: aN })
          break
      }
      if (this.type in { text: 1, image: 1 } && (aA != 1 || ax != 1)) {
        if (this.transformations) {
          this.transformations[2] = 'scale('[J](aA, ',', ax, ')')
          this.node[f]('transform', this.transformations[t](' '))
          aI = aA == -1 ? -aU.x - (az || 0) : aU.x
          aG = ax == -1 ? -aU.y - (aK || 0) : aU.y
          this.attr({ x: aI, y: aG })
          aU.fx = aA - 1
          aU.fy = ax - 1
        } else {
          this.node.filterMatrix = ' progid:DXImageTransform.Microsoft.Matrix(M11='[J](
            aA,
            ', M12=0, M21=0, M22=',
            ax,
            ", Dx=0, Dy=0, sizingmethod='auto expand', filtertype='bilinear')"
          )
          aL.filter = (this.node.filterMatrix || w) + (this.node.filterOpacity || w)
        }
      } else {
        if (this.transformations) {
          this.transformations[2] = w
          this.node[f]('transform', this.transformations[t](' '))
          aU.fx = 0
          aU.fy = 0
        } else {
          this.node.filterMatrix = w
          aL.filter = (this.node.filterMatrix || w) + (this.node.filterOpacity || w)
        }
      }
      aU.scale = [aE, aD, R, E][t](' ')
      this._.sx = aE
      this._.sy = aD
    }
    return this
  ...
  l.easing_formulas = {
    ...
    elastic: function(E) {
      ...
      var i = 0.3,
        e = i / 4
      return L(2, -10 * E) * Math.sin(((E - e) * (2 * Math.PI)) / i) + 1
    },
    bounce: function(R) {
      var i = 7.5625,
        E = 2.75,
  ...
  s[v].animate = function(aM, aD, aC, au) {
    clearTimeout(this.animation_in_progress)
    if (l.is(aC, 'function') || !aC) {
      au = aC || null
    }
    var aG = {},
      E = {},
        ...
        if (aE in F) {
          ...
          switch (F[aE]) {
            case 'number':
              ...
              break
            case 'colour':
              aG[aE] = l.getRGB(aG[aE])
              var aF = l.getRGB(E[aE])
              aA[aE] = {
                r: (aF.r - aG[aE].r) / aD,
                g: (aF.g - aG[aE].g) / aD,
                b: (aF.b - aG[aE].b) / aD,
              ...
              break
            case 'path':
              var av = ag(aG[aE], E[aE])
              aG[aE] = av[0]
              E[aE] = av[1]
              aA[aE] = []
              for (var aI = 0, ay = aG[aE][z]; aI < ay; aI++) {
                aA[aE][aI] = [0]
                for (var aH = 1, aK = aG[aE][aI][z]; aH < aK; aH++) {
                  aA[aE][aI][aH] = (E[aE][aI][aH] - aG[aE][aI][aH]) / aD
                }
              }
              break
            case 'csv':
              ...
              switch (aE) {
                case 'translation':
                  ...
                  break
                case 'rotation':
                  aG[aE] = ax[1] == e[1] && ax[2] == e[2] ? ax : [0, e[1], e[2]]
                  aA[aE] = [(e[0] - aG[aE][0]) / aD, 0, 0]
                  break
                case 'scale':
                  aM[aE] = e
                  aG[aE] = (aG[aE] + w)[H](at)
                  aA[aE] = [(e[0] - aG[aE][0]) / aD, (e[1] - aG[aE][1]) / aD, 0, 0]
                  break
                case 'clip-rect':
                  aG[aE] = (aG[aE] + w)[H](at)
                  aA[aE] = []
    ...
    ;(function aJ() {
      var aO = new Date() - R,
        ...
        aN
      if (aO < aD) {
        var aU = l.easing_formulas[aC] ? l.easing_formulas[aC](aO / aD) : aO / aD
        for (var aS in aG) {
          if (aG[h](aS)) {
            switch (F[aS]) {
              case 'number':
                aN = +aG[aS] + aU * aD * aA[aS]
                break
              case 'colour':
                aN =
                  'rgb(' +
                  [
                    aL(ai(aG[aS].r + aU * aD * aA[aS].r)),
                    aL(ai(aG[aS].g + aU * aD * aA[aS].g)),
                    aL(ai(aG[aS].b + aU * aD * aA[aS].b)),
                  ][t](',') +
                  ')'
                break
              case 'path':
                aN = []
                for (var aQ = 0, aX = aG[aS][z]; aQ < aX; aQ++) {
                  aN[aQ] = [aG[aS][aQ][0]]
                  for (var aP = 1, aR = aG[aS][aQ][z]; aP < aR; aP++) {
                    aN[aQ][aP] = +aG[aS][aQ][aP] + aU * aD * aA[aS][aQ][aP]
                  }
                  aN[aQ] = aN[aQ][t](' ')
                }
                aN = aN[t](' ')
              ...
              case 'csv':
                switch (aS) {
                  case 'translation':
                    ...
                    break
                  case 'rotation':
                    aN = +aG[aS][0] + aU * aD * aA[aS][0]
                    aG[aS][1] && (aN += ',' + aG[aS][1] + ',' + aG[aS][2])
                    break
                  case 'scale':
                    aN = [
                      +aG[aS][0] + aU * aD * aA[aS][0],
                      +aG[aS][1] + aU * aD * aA[aS][1],
                      2 in aM[aS] ? aM[aS][2] : w,
                      3 in aM[aS] ? aM[aS][3] : w,
                    ][t](' ')
                    break
                  case 'clip-rect':
                    aN = []
        ...
        aw.attr(aW)
        aw.animation_in_progress = setTimeout(aJ)
        l.svg && d.safari()
      } else {
        ;(az.x || az.y) && aw.translate(-az.x, -az.y)
        aM.scale && (aM.scale = aM.scale + w)
        aw.attr(aM)
        clearTimeout(aw.animation_in_progress)
        l.svg && d.safari()
        l.is(au, 'function') && au.call(aw)
      }
      aB = aO
    })()
    return this
  }
  s[v].translate = function(e, E) {
    if (e == null) {
    ...
    switch (this.type) {
      case 'circle':
      case 'ellipse':
        this.attr({ cx: +e + this.attrs.cx, cy: +E + this.attrs.cy })
        break
      case 'rect':
      case 'image':
      case 'text':
        this.attr({ x: +e + this.attrs.x, y: +E + this.attrs.y })
        break
      case 'path':
        var i = g(this.attrs.path)
        i[0][1] += +e
        i[0][2] += +E
        this.attr({ path: i })
        break
  ...
  var p = function(e) {
    ...
    this[z] = 0
    if (e) {
      for (var E = 0, R = e[z]; E < R; E++) {
        if (e[E] && (e[E].constructor == s || e[E].constructor == p)) {
          this[this.items[z]] = this.items[this.items[z]] = e[E]
          this[z]++
        }
      }
    }
  ...
  p[v][ae] = function() {
    var au, e
    for (var E = 0, R = arguments[z]; E < R; E++) {
      au = arguments[E]
      if (au && (au.constructor == s || au.constructor == p)) {
        e = this.items[z]
        this[e] = this.items[e] = au
        this[z]++
      }
    }
    return this
  ...
  for (var al in s[v]) {
    if (s[v][h](al)) {
      p[v][al] = (function(e) {
        return function() {
          for (var E = 0, R = this.items[z]; E < R; E++) {
            this.items[E][e][ao](this.items[E], arguments)
          }
          return this
        }
      })(al)
  ...
  p[v].attr = function(E, aw) {
    if (E && l.is(E, 'array') && l.is(E[0], 'object')) {
      for (var e = 0, av = E[z]; e < av; e++) {
        this.items[e].attr(E[e])
      }
    } else {
      for (var R = 0, au = this.items[z]; R < au; R++) {
        this.items[R].attr[ao](this.items[R], arguments)
      }
    }
    return this
  }
  p[v].animate = function(av, E, ay, ax) {
    if (l.is(ay, 'function') || !ay) {
      ax = ay || null
    }
    var e = this.items[z],
      R = e,
    ...
    if (ax) {
      ...
      while (R--) {
        this.items[R].animate(av, E, ay || au, au)
      }
    } else {
      while (R--) {
        this.items[R].animate(av, E, ay)
      }
    }
    return this
  }
  p[v].getBBox = function() {
    var e = [],
      aw = [],
      E = [],
      au = []
    for (var R = this.items[z]; R--; ) {
      var av = this.items[R].getBBox()
      e[ae](av.x)
      aw[ae](av.y)
      E[ae](av.x + av.width)
      au[ae](av.y + av.height)
    }
    e = V[ao](0, e)
    aw = V[ao](0, aw)
    return { x: e, y: aw, width: r[ao](0, E) - e, height: r[ao](0, au) - aw }
  }
  l.registerFont = function(i) {
    if (!i.face) {
      return i
    }
    this.fonts = this.fonts || {}
    var R = { w: i.w, face: {}, glyphs: {} },
      E = i.face['font-family']
    for (var aw in i.face) {
      if (i.face[h](aw)) {
        R.face[aw] = i.face[aw]
      }
    }
    ...
    if (!i.svg) {
      R.face['units-per-em'] = u(i.face['units-per-em'], 10)
      for (var au in i.glyphs) {
        if (i.glyphs[h](au)) {
          var av = i.glyphs[au]
          R.glyphs[au] = {
            w: av.w,
  ...
  d.getFont = function(ay, az, E, au) {
    au = au || 'normal'
    E = E || 'normal'
    az = +az || { normal: 400, bold: 700, lighter: 300, bolder: 800 }[az] || 400
    var av = l.fonts[ay]
    if (!av) {
      var R = new RegExp('(^|\\s)' + ay[Q](/[^\w\d\s+!~.:_-]/g, w) + '(\\s|$)', 'i')
    ...
    var aw
    if (av) {
      for (var ax = 0, aA = av[z]; ax < aA; ax++) {
        aw = av[ax]
        if (
          aw.face['font-weight'] == az &&
          (aw.face['font-style'] == E || !aw.face['font-style']) &&
          aw.face['font-stretch'] == au
        ) {
          break
        }
      }
  ...
  d.print = function(aA, az, ax, E, aE) {
    var av = this.set(),
      ay = (ax + w)[H](w),
      e = 0,
      aD = w,
      au
    l.is(E, 'string') && (E = this.getFont(E))
    if (E) {
      au = (aE || 16) / E.face['units-per-em']
      for (var aw = 0, aB = ay[z]; aw < aB; aw++) {
        var R = (aw && E.glyphs[ay[aw - 1]]) || {},
          aC = E.glyphs[ay[aw]]
        e += aw ? (R.w || E.w) + ((R.k && R.k[ay[aw]]) || 0) : 0
        aC &&
          aC.d &&
          av[ae](this.path(aC.d).attr({ fill: '#000', stroke: 'none', translation: [e, 0] }))
      }
      av.scale(au, au, 0, az).translate(aA, (aE || 16) / 2)
    }
    return av
  }
  l.format = function(i) {
    var e = l.is(arguments[1], 'array') ? [0][J](arguments[1]) : arguments
    i &&
      l.is(i, 'string') &&
      e[z] - 1 &&
      (i = i[Q](/\{(\d+)\}/g, function(R, E) {
        return e[++E] == null ? w : e[E]
      }))
    return i || w
  }
  l.ninja = function() {
  ...
  if (window.Ext) {
    Ext.get(elem).on(
      ...
      function(event) {
        ...
        this.onMouseDown(
          event.getPageX() - offset()[0],
          event.getPageY() - offset()[1],
          event.getTarget()
        )
        return false
      },
      ...
      if (this.action == 'move') {
        ...
        if (!this.onGrabXY) {
          ...
          if (this.selected[0].type == 'ellipse') {
            this.onGrabXY = [this.selected[0].attr('cx'), this.selected[0].attr('cy')]
            ...
            this.onGrabXY = [this.selected[0].attr('x'), this.selected[0].attr('y')]
          }
          //this.onGrabBox = this.selected[0].getBBox()
        }
        var box = this.selected[0].getBBox()
        var nxy = this.returnRotatedPoint(
          x,
          y,
          box.x + box.width / 2,
          box.y + box.height / 2,
          -this.selected[0].attr('rotation')
        )
        x = nxy[0] - 5
        y = nxy[1] - 5
        if (this.selected[0].type == 'rect') {
          ...
          this.selected[0].scale(
            (x - this.onGrabXY[0]) / this.onGrabXY[2],
            (y - this.onGrabXY[1]) / this.onGrabXY[3],
            this.onGrabXY[0],
            this.onGrabXY[1]
          )
        }
  ...
  var shape = this.draw
    ...
    .mouseover(function() {
      ...
      try {
        ...
        if (
          this.paper.editor.trackers[0][0].attr('rotation').split(' ')[0] == '0' &&
          this.paper.editor.action != 'resize'
        ) {
          //ugh
...
VectorEditor.prototype.trackerCircle = function(x, y) {
  ...
  var shape = this.draw
    ...
    .mouseover(function() {
      ...
      try {
        //easy way out! try catch!
        if (this.paper.editor.trackers[0][0].attr('rotation').split(' ')[0] == '0') {
          //ewwie!
...
VectorEditor.prototype.tooltip = function(t, bbox) {
  ...
  rect
    .attr('fill', '#7cb6ef') //it's the first 6 letters of the hex SHA1 hash of "false"
    .insertBefore(text)
...
VectorEditor.prototype.showTracker = function(shape) {
  ...
  tracker.push(
    this.markTracker(
      this.draw.ellipse(box.width / 2, box.height / 2, 7, 7).attr({
        stroke: 'gray',
        'stroke-opacity': 0.5,
        fill: 'gray',
        'fill-opacity': 0.15,
...
VectorEditor.prototype.showGroupTracker = function(shape) {
  ...
  tracker.push(
    this.draw.rect(-6, -6, box.width + 11, box.height + 11).attr({
      'stroke-dasharray': '-',
      stroke: 'blue',
    })
  )
...
Ax.loadShapes = function(shapes, noattachlistener, instance) {
  //instance; probably need a better name for this. but its the richdraw/onlypaths/viewer/etc reference.

  if (typeof shapes == 'string') {
    //try un-scrabling this!
...
Ax.loadShape = function(shape, noattachlistener, instance) {
  ...
  for (var now in Ax.backcompat) {
    ...
    if (!shape[now] && shape[Ax.backcompat[now]]) {
      //if new one no existy, but old one existy
...
function $(e) {
  //this is a little hack since OnlyPaths used to be based off of Richdraw
...
Ax.onlypaths = {
  //todo: change Ax.onlypaths to soemthing more generic
...
Ax.drawinit_core = function() {
  Ax.canvas = new VectorEditor(
    $('drawcanvas'),
    Ext.get('drawcanvas').getWidth(),
    Ext.get('drawcanvas').getHeight()
  )
  ...
  Ax.canvas.on('select', function(event, shape) {
    if (shape && !wave2.isPlayback()) {
      ...
      if (wave2.isPlayback())
        Ax.msg(
          'Playback Mode',
          'Wave is reporting that it is in Playback mode. Editing has been disabled.'
        )
      return false
    }
  })
...
Ax.reloadCanvas = function() {
  //now a very very robust function, should be able to recover from most errors, even most really random ones
  ...
  try {
    ...
    Ax.msg(
      'Sorry',
      'GFX Editor has encountered a critical error. The canvas data may be unrecoverable.'
    )
  }
  try {
    Ax.canvas.deleteAll()
  ...
  try {
    ...
    log.push('FO7: ' + err)
    Ax.msg('Sorry', 'Recovery might have failed. You may have to restart the application.')
  }
  try {
  ...
  if (log.length > 0) {
    ...
    Ax.msg(
      'Canvas Reloaded',
      'This should have resolved most canvas-related issues. Canvas reinitialized in ' + time + 'ms'
    )
  }
}
...
*/
  ...
  */
    ...
    Ax.toastMsg(
      'Error',
      'VectorEditor, the drawing component of the Ajax Animator has crashed. To attempt to fix this, go to <b>Tools->Recovery->Reload Canvas</b>.'
    )
  }
...
Ax.viewer_load_frame = function(frame, layers, canvas, tweenfunc, framecount) {
  ...
  for (var layer in layers) {
    ...
    if (layers[layer].keyframes.indexOf(frame) != -1 && layers[layer].visible) {
      ...
      Ax.loadShapes(
        (tweenfunc ? tweenfunc : Ax.getSFTween)(
          frame,
          Ax.largest_nonempty(frame, layer, layers),
          Ax.smallest_nonempty(frame, layer, layers),
          layer,
    ...
    } else if (Ax.largest_nonempty(frame, layer, layers)) {
...
Ax.clipboard_clear = function() {
  ...
  var clipboard_items = Ax.viewport
    .findById('clipboard')
    .getStore()
    .getRange(1)
    ...
    Ext.apply(this, {
          ...
          items: [
            {
              ...
              listeners: {
                activate: function() {
                  if (!Ax.timeline.el) {
                    ;(function() {
                      //shit so much polling. event based would be better
                      if (Ax.viewport) {
                        try {
                          Ax.initTimeline()
                          Ax.addLayer()
                          ...
                          function(btn, w) {
                            if (btn == 'ok') {
                              if (parseInt(w) < 100000 && parseInt(w) > 1) {
                                  ...
                                  function(btn, h) {
                                    if (btn == 'ok') {
                                      if (parseInt(h) < 100000 && parseInt(h) > 1) {
                                        ...
                                        Ax.msg(
                                          'Canvas Height not in range',
                                          'The canvas height must be larger than 1 and below 100,000'
                                        )
                                      }
                                    }
                                  },
                                ...
                                Ax.msg(
                                  'Canvas Width not in range',
                                  'The canvas width must be larger than 1 and below 100,000'
                                )
                              }
                            }
                          },
      ...
      getText: function(slider){return String.format('Canvas Zoom: {0}%', slider.getValue())}
        ...
        */
                      ...
                      menu: [
                        {
                          ...
                          menu: [
                            ...
                            },
                            {
                              ...
                              iconCls: 'tb_recover_application',
                              handler: function() {
                        ...
                        },
                        {
                          ...
                          handler: function() {
                            Ext.MessageBox.prompt(
                              'Onion Skinning',
                              'Enter value for onion skinning opacity or 0 to disable.',
                              function(btn, text) {
                                if (btn == 'ok') {
                          ...
                          menu: [
                            {
                              ...
                              iconCls: 'tb_info',
                              handler: function() {
                                Ext.MessageBox.alert('Editor Frame JSON', Ax.dumpshapes('json'))
                              },
                            },
                            {
                              text: 'Select All',
                            ...
                            }, //woah! look! the whole thing is progressively 2 characters more!
                            {
                              text: 'Copy',
                              iconCls: 'tb_copy',
                              handler: function() {
...

                        {
                          ...
                          handler: function() {
                            Ext.MessageBox.prompt(
                              'Copy Frame Data',
                              'Replace canvas with contents from another frame.',
                              function(btn, text) {
                                if (btn == 'ok') {
                                  if (parseInt(text) > 0) {
                                    ...
                                    Ax.msg(
                                      'Frame Number not in range',
                                      'The frame must be larger than zero'
                                    )
                                  }
                                }
                              },
...

                        {
                          ...
                          handler: function() {
                            Ext.MessageBox.prompt(
                              'Import Shape form JSON',
                              'Write your shape JSON dump below (Must be correct version).',
                              function(btn, text) {
                                if (btn == 'ok') {
                                  try {
                          ...
                          menu: [
                            {
                              ...
                              handler: function() {
                                if (
                                  ...
                                  gadgets.window.adjustHeight(
                                    prompt('enter new height in pixels', window.innerHeight)
                                  )
                                } else {
                                  Ax.msg(
                                    'Height not Adjustable',
                                    'The required APIs are not present.'
                                  )
                                }
                              },
                            },
                              ...
                              menu: [
                                {
                                  ...
                                  handler: function() {
                                    ...
                                    Ax.msg(
                                      ...
                                      'Wave API is now using emulated version'
                                    )
                                  },
                                },
                                {
                                  text: 'Real API (If applicable)',
                                  handler: function() {
                                    wave2.mode = 'wave'
                                    Ax.msg(
                                      'Switched to real API',
                                      'The wave emulator has been disabled but will still be used if the wave API is not available.'
                                    )
                                  },
                                },
                                {
                                  ...
                                  handler: function() {
                                    ...
                                    Ax.msg(
                                      'Emulator State Cloned',
                                      'The current wave state has been cloned to the emulator. It is safe to switch to emulator.'
                                    )
                                  },
                                },
                              ],
...

                            {
                              ...
                              handler: function() {
                                ...
                                Ax.msg(
                                  ...
                                  'Deleted things marked for deletion but within safe deletion threshold.'
                                )
                              },
                            },
                            {
                              ...
                              handler: function() {
                                ...
                                Ax.msg(
                                  'Garbage Collection Complete',
                                  'Deleted EVERYTHING marked for deletion.'
                                )
                              },
                            },
                          ],
                  ...
                  html:
                    '<div class="x-border-layout-ct canvas_container">' +
        ...
        */
                      ...
                      menu: [
                        {
                          ...
                          handler: function() {
                            ...
                            Ax.msg(
                              'Uploading animation',
                              'The animation is being uploaded to the server with ID ' + id + '.'
                            )
                            autopost(
                              Ax.files.xssds,
                              {
                              ...
                              function() {
                                ...
                                Ext.MessageBox.alert(
                                  'Share URL',
                                  "The animation has been sucessfully uploaded and a window has been launched. You may share the following URL:<br><a href='" +
                                    share +
                                    "'>" +
                                    share +
                                    '</a>'
...

                    {
                      ...
                      handler: function() {
                        Ext.MessageBox.prompt(
                          'Set Animation Speed',
                          'New speed in frames per second.',
                          function(btn, text) {
                            if (btn == 'ok') {
                              if (parseFloat(text) < 1000 && parseFloat(text) > 0) {
                                ...
                                Ax.msg(
                                  'Sucessfully set Animation speed',
                                  'The animation is now ' + text + 'fps'
                                )
                              } else {
                                Ax.msg(
                                  'Animation Speed not in Range',
                                  'The speed of the animation must be larger than zero and below 1000'
                                )
                              }
                            }
                          },
                    ...
                    },
                    {
                      ...
                      showText: true,
                      items: [
                        { iconCls: 'tb_play', text: 'Play' },
                        { iconCls: 'tb_pause', text: 'Pause', checked: true },
                      ],
                      ...
                      menu: [
                        ...
                        },
                        {
                          ...
                          menu: [
                            ...
                            {
                              text: 'Processing',
                              iconCls: 'tb_processing',
                              handler: function() {
                                Ax.ex.processing.save()
                              },
                            },
                            {
                              text: 'Silverlight',
                        ...
                        },
                        {
                          ...
                          handler: function() {
                            Ax.setAnimationName(
                              prompt(
                                'Enter New Animation Name (Not Synced and not used)',
                                Ax.animation.name
                              )
                            )
                          },
...
Ax.largest_nonempty = function(frame, layer, object) {
  ...
  return nonempty.sort(function(a, b) {
    return b - a
  })[0] //sort descending and pull the first result (largest)
}
...
Ax.count_frames = function(layers, startAt) {
  ...
  for (var layer in layers) {
    ...
    if (layer_frames > startAt) {
      //if this is bigger than current value
...
Ax.getSFTween_core = function(frame, frame1, frame2, layer, store, clonefunc) {
  //get single frame tween
  ...
  for (var i in frames_comp) {
    if (frame2_data[i] && frame1_data[i]) {
      for (var a in frame2_data[i]) {
        tween_frame[i][a] = Ax.tweenAttribute(
          a,
          frame1,
          frame2,
          frame1_data[i][a],
...
Ax.tweenAttribute = function(name, frame1, frame2, value1, value2, index) {
  if (value1 == value2) {
    //if they are the same, why bother?
    return value1
  }
...
Ax.tweenHex = function(frame1, frame2, value1, value2, index) {
  ...
  return (
    '#' +
    [
      Ax.toHex(Ax.tweenNumber(frame1, frame2, parseInt(value1.R), parseInt(value2.R), index)),
      Ax.toHex(Ax.tweenNumber(frame1, frame2, parseInt(value1.G), parseInt(value2.G), index)),
      Ax.toHex(Ax.tweenNumber(frame1, frame2, parseInt(value1.B), parseInt(value2.B), index)),
    ].join('')
  )
}
...
Ax.tweenNumber = function(frame1, frame2, value1, value2, index) {
  //frame1, frame2, first number, second number, index (from first)
...
Ax.tween = function(frame1, frame2, layer) {
  //this function loops through frames inbetween and flags them as tweens
  ...
  if (frame1 && frame2) {
    ...
    for (var i = frame1 + 1; i < frame2; i++) {
      //loop through frames from frame1 to frame2
      Ax.toTween(i, layer) //huh? oh. tell the timelinezo
    } //end loop
  } //end if tingy
} //end functioney

Ax.getSFTween = function(frame, frame1, frame2, layer, store) {
  //get single frame tween
  if (!frame) {
    frame = Ax.tcurrent.frame
  } //pull defaults if none
  if (!layer) {
    layer = Ax.tcurrent.layer
  } //same as above,but i'll repeat it so i get a higher comment-ratio: pull defaults if none
  if (!frame1) {
    frame1 = Ax.largest_nonempty(frame, layer)
  } //pull the last keyframe if none
  if (!frame2) {
    frame2 = Ax.smallest_nonempty(frame, layer)
  } //pull the next keyframe if none, which is essentially the same thing as the one before
  ...
  if (!store[frame1]) {
    Ax.toastMsg(
      'Error!',
      "Ajax Animator's Tweening Engine has encountered a potentially critical error because store[frame1 (" +
        frame1 +
        ')] is non-existant. '
    )
    //store[frame1] = [];
  ...
  if (!store[frame2]) {
    Ax.toastMsg(
      'Error!',
      "Ajax Animator's Tweening Engine has encountered a potentially critical error because store[frame2 (" +
        frame2 +
        ')] is non-existant.'
    )
    //store[frame2] = [];
...
Ax.controls = {
  ...
  toggle: function() {
    if (Ax.preview_timeout) Ax.controls.pause()
    else Ax.controls.play()
  },
  pause: function() {
    Ax.viewport.findById('maintabpanel').activate(1)
    clearTimeout(Ax.preview_timeout)
  ...
  for (var i in Ax.layers) {
    ...
    if (i == layer) {
      ...
      if (Ax.layers[i].visible != true) {
        Ax.msg(
          'Layer Visibility',
          'Please note that the current layer will always show regardless of visibility settings.'
        )
      }
...
Ax.loadframe_core = function(frame, layer, noattachlistener) {
  ...
  if (Ax.isKeyframe(frame, layer)) {
    ...
    Ax.loadShapes(
      Ax.getSFTween(
        frame,
        Ax.largest_nonempty(frame, layer),
        Ax.smallest_nonempty(frame, layer),
        layer
      ),
      noattachlistener
    ) //load tween
...
Ax.autodiff = function() {
  ...
  if (Ax.tcurrent.layer && Ax.tcurrent.frame) {
    //..only if the current frame *exists*
    //here is the magical code that does the history revision saving stuffs

    if (Ax.iscanvas() && Ax.diff_core(Ax.dumpshapes(), Ax.getcanvas()) != true) {
    ...
    if (Ax.isTween() == true && Ax.diff_core(Ax.dumpshapes(), Ax.getSFTween()) != true) {
      ...
      Ax.diff_core(
        Ax.getcanvas(Ax.largest_nonempty(Ax.tcurrent.frame, Ax.tcurrent.layer), Ax.tcurrent.layer),
        Ax.dumpshapes()
      ) != true &&
      !Ax.isTween()
    ) {
...
Ax.diff_attr = function(value1, value2, attrid) {
  if (
    Ax.diff_exclude.indexOf(attrid) == -1 &&
    value1 !== null &&
    value2 !== null &&
    value1 !== undefined &&
    value2 !== undefined
    ...
    if (attrid == 'transform') {
      ...
      for (var i = 0; i < value2.length; i++) {
        if (value2[i][0] == 'M' || value2[i][0] == 'L') {
          if (
            value2[i][1].toFixed(3) != value1[i][1].toFixed(3) ||
        ...
        items: [
          {
            ...
            items: [
              ...
              },
              {
                ...
                border: false,
                html:
                  '<div class="x-border-layout-ct canvas_container"><div id="playercanvas" class="canvas"></div></div>',
              },
            ],
            autoScroll: true,
            tools: [
              ...
              },
              {
                id: 'help',
                qtip:
                  'View and share animations with other users. Use the left panel to browse for animations,' +
            ...
            bbar: [
              {
                ...
                handler: function() {
                  Ax.viewport
                    .findById('treebrowse')
                    .getLoader()
                    .load(Ax.viewport.findById('treebrowse').getRootNode())
                },
              },
            ],
      ...
      items: [
        {
          ...
          border: false,
          html:
            "<div id='timeline_core' class='x-unselectable' style='height: 100%; width: 100%'>Loading Frames...</div>",
        },
        {
          region: 'west',
          width: 150,
...
Ax.tstat = {
  //statistics for the count of frames and layers (displayed in timeline, not animation)
  layers: 0, //layers
  frames: 0, //frames.
}

Ax.tcurrent = {
  //currently selected frame/layer
...
Ax.addLayer = function(layername) {
  ...
  Ax.viewport
    .findById('layers')
    .getStore()
    .add(Ax.layers[layername].record)
...
Ax.addFrames = function(frames) {
  //mind the s, this just loops through whatever number and makes so many frames
...
Ax.selectFrame = function(frame, layer) {
  ...
  Ax.viewport
    .findById('layers')
    .getSelectionModel()
    .selectRecords([Ax.layers[layer].record], false)
  //select the layer
...
Ax.selectFrame_core = function(frame, layer) {
  ...
  Ext.get('timeline_core')
    .parent()
    .scrollChildIntoView(Ax.timeline.mask)
}
...
Ax.deleteFrame = function(frame, layer) {
  ...
  if (frame == 1) {
    Ax.msg(
      "Can't delete first frame",
      "You just can't delete the first frame. It's magical so just try to live with it."
    )
    return false
  }
...
Ax.toKeyframe = function(frame, layer, nobroadcast) {
  ...
  if (Ax.isTween(frame, layer)) {
    //this never sees light, because the thing above keeps it from ever executing
...
Ax.create_timeline_mask = function() {
  ...
  new Ext.ToolTip({
    ...
    listeners: {
      show: function(tooltip) {
        tooltip.setTitle(
          'Frame ' + Ax.tcurrent.frame.toString() + ' ' + Ax.tcurrent.layer.toString()
        )
...
Ax.initTimeline = function() {
  ...
  Ext.get('timeline_core')
    .parent()
    .on('mousedown', function(event, target) {
  ...
  Ext.get('timeline_core')
    .parent()
    .on('contextmenu', function(event, target) {
      //console.log(event,target)
      event.stopEvent()
      //console.log(Ax.tcurrent)
...
Ax.preview_increment = function(noplay) {
  ...
  */
  ...
  if (!noplay)
    Ax.preview_timeout = setTimeout(function() {
      Ax.preview_increment()
    }, Math.max(0, 1000 / Ax.framerate - Ax.performance))
}
...
Ax.format = {
  support: {
    //format support. minimum version, maximum version
    min: 20,
    max: 21,
  },
...
Ax.import_animation = function(markup) {
  if (typeof markup == typeof 'tehkooliest') {
    //if its in json, then decode it first
    markup = Ext.util.JSON.decode(markup)
  }
...
Ax.import_animation_core = function(layers) {
  ...
  Ax.viewport
    .findById('layers')
    .getStore()
    .removeAll() //remove all entries from layers panel
...
*/
  ...
  for (var layerx in layers) {
    ...
    for (
      var i = 0;
      i <
      layers[layerx].keyframes.sort(function(a, b) {
        return b - a
      })[0] +
        1;
      i++
...
Ax.reload_animation = function() {
  ...
  Ax.msg(
    'Animation Reloaded',
    'The current animation was reloaded. This hopefully has resolved most issues related to the timeline and other components.'
  )
}
  ...
  if (jsonmarkup != false) {
    if (jsonmarkup.revision) {
      if (Math.round(jsonmarkup.revision) > Ax.format.support.max) {
        Ax.msg(
          'Warning! Proof of time travel',
          'It seems that the animation you are attempting to load was created with a future version of the ajax animator. It may contain data that can not be loaded properly in this version, or may load perfectly fine.'
        )
      }
      if (Math.round(jsonmarkup.revision) < Ax.format.support.min) {
        Ax.msg(
          'Warning!',
          'The animation you are attempting to load seems to be created by an older, unsupported version. It is more than likely some information here will not load properly.'
        )
      }
    }
    ...
    if (markup.indexOf(';;') != -1) {
      Ax.msg(
        ...
        'The animation looks like data from the AXML format used by Ajax Animator 0.14.7 and below. It is not supported natively in this release due to the usage of a new format in 0.20+.'
      )
    } else {
      Ax.msg(
        'Unable to load animation!',
        'The animation could not be loaded because it is malformed. Check the data for corruption, or from an unsupported source.'
      )
    }
  }
}
...
Ax.animationinfo = function(type) {
  ...
  if (type == 'core') {
    return (
      ...
      Ax.animation.name +
      ':</b><br />Generator: ' +
      (Ax.animation.markup.generator
        ? Ax.animation.markup.generator.app + ' build ' + Ax.animation.markup.generator.build
        : 'Unknown') +
      '<br />Format Version: ' +
...
Ax.save = {
      ...
      buttons: [
        {
          ...
          handler: function() {
            this.ownerCt
              .findById('outtext')
              .setValue(Ax.export_animation(Ax.animation.markup, 'json'))
          },
        },
        {
          text: 'Close',
      ...
      items: [
        {
          ...
          border: false,
          html:
            'You may copy the text below and save it somewhere to open later from the File->Open->From Text menu option.',
        },
        {
          region: 'center',
          layout: 'fit',
  ...
  comp_datauri: function(data, base64) {
    window.location =
      'data:application/octetstream;base64,' + base64
        ? data
        : Ext.ux.base64.encode(data ? data : Ax.export_animation(Ax.animation.markup, 'json'))
  },
  comp_iframe: function(data, name, base64, alt_proxy) {
    //looks like its not actually an iframe -_-
    Ax.msg(
      'Saving...',
      'The request is being processed by the server and may take a long time depending on the size of the animation.' +
            ...
            Ext.Ajax.request({
              ...
              success: function(e) {
                if (e.responseText != 'working') {
                  Ax.toastMsg(
                    'Probable Failure',
                    'Upload handling server appears not to be working'
                  )
                }
              },
              failure: function() {
      ...
      buttons: [
        {
          ...
          handler: function() {
            Ext.MessageBox.alert(
              ...
              'Loading an animation from an external server has been disabled for (pseudo) security purposes.'
            )
            //Ax.autoimport(this.ownerCt.findById("loadtext").getValue())
          },
        },
 ...
 */
Ax.ex.array = function(format) {
  //returns an array of every single frame (single layered) tweened when necessary
  Ax.autodiff() //read the comment in player.js
  var output = [],
    frame = 1,
    total_frames = Ax.count_frames(Ax.layers)
...
Ax.ex.array.save = function() {
  Ax.msg(
    'Notes on exporting to OnlyPaths JSON Frame List',
    'Export to OnlyPaths JSON Frame List does not contain layer or tween data.'
  )
 ...
 */
Ax.ex.swf = function() {
  //normally this actually does something, but this is a rare occasion where nothign happens
...
Ax.ex.swf.save = function() {
  //savenessy
  Ax.msg(
    'Notes on exporting to Flash',
    'Export to flash currently uses the limited freemovie library. Better flash export will be available later using another library such as Transform SWF. '
  )
...
Ax.ex.swf.check = function() {
  Ax.ajax({
    ...
    success: function(e) {
      //when the magickalness happens
      if (e.responseText != 'working') {
        //lets test if its working
...
Ax.ex.silverlight.line = function(shape) {
  return new Ext.XTemplate(
    '<Line X1="{left}" Y1="{top}" Fill="{fillColor}" Stroke="{lineColor}" X2="{[values.left+values.width]}" Y2="{[values.top+values.height]}"  StrokeThickness="{lineWidth}" />'
  ).apply(shape)
}

Ax.ex.silverlight.rect = function(shape) {
  return new Ext.XTemplate(
    '<Rectangle Canvas.Left="{left}" Canvas.Top="{top}" Fill="{fillColor}" Stroke="{lineColor}" Width="{width}" Height="{height}" StrokeThickness="{lineWidth}"><Rectangle.RenderTransform><RotateTransform Angle="{[Ax.parseTransform(values.transform)[0]]}"/></Rectangle.RenderTransform></Rectangle>'
  ).apply(shape)
}

Ax.ex.silverlight.path = function(shape) {
  return new Ext.XTemplate(
    '<Path Data="{points}"  Fill="{fillColor}" Stroke="{lineColor}" StrokeThickness="{lineWidth}" />'
  ).apply(shape)
}

Ax.ex.silverlight.text = function(shape) {
  return new Ext.XTemplate(
    '<TextBlock FontSize="{textSize}" Fill="{fillColor}" Stroke="{lineColor}"  FontFamily="{textFamily}" Canvas.Left="{left}" Canvas.Top="{top}">{text}</TextBlock>'
  ).apply(shape)
}

Ax.ex.silverlight.image = function(shape) {
  return new Ext.XTemplate(
    '<Rectangle Canvas.Left="{left}" Canvas.Top="{top}" Width="{width}" Height="{height}"><Rectangle.Fill><ImageBrush ImageSource="{href}" /></Rectangle.Fill></Rectangle>'
  ).apply(shape)
}

Ax.ex.silverlight.ellipse = function(shape) {
  return new Ext.XTemplate(
    '<Ellipse Canvas.Left="{left}" Fill="{fillColor}" Stroke="{lineColor}" StrokeThickness="{lineWidth}" Canvas.Top="{top}" Width="{width}" Height="{height}" />'
  ).apply(shape)
}
Ax.ex.silverlight.save = function() {
  //return Ax.save.computer(Ax.ex.silverlight(),Ax.animation.name+".xaml")
  Ax.msg(
    'Notes on exporting to Silverlight (XAML)',
    'Export to Silverlight is not complete, animations will be condensed to a single canvas of overlapping shapes and some shape data may not be exported.'
  )
...
Ax.ex.javafx.save = function() {
  Ext.MessageBox.alert(
    'JavaFX Export Not Available',
    'We have not finished implementing JavaFX export.'
  )
}
...
Ax.ex.processing = function() {
  var data = Ax.ex.array(), //the magic behind it all;
    setup = [
      '//The compilier for this was quickly hacked together', //my little header
...
Ax.ex.processing.line = function(shape) {
  return (
    'line(' +
    [shape.left, shape.top, shape.left + shape.width, shape.top + shape.height].join(', ') +
    ');'
  )
}
...
Ax.ex.processing.save = function() {
  Ax.msg(
    'Notes on exporting to Processing',
    'Export to processing is not complete, data such as images, paths, polygons, and rotation will not be exported. Also, it does not use tweening so the files will be massive.'
  )
  Ax.save.computer(Ax.ex.processing(), Ax.animation.name + '.pde')
}
...
Ax.ex.gif.save = function() {
  Ax.msg(
    'Notes on exporting to Animated GIF',
    'Export to Animated GIF is not complete, data such as images and rotation will not be exported.'
  )
...
Ax.ex.smil.save = function() {
  Ext.MessageBox.alert(
    'SMIL Export Not Available',
    "I'm trying to get a new diff subsystem which will allow better export and SMIL will be the first use for it."
  )
}
...
Ax.getTipData = function() {
  if (!Ax.tipIndex) {
    ...
    Ax.tipIndex = Math.floor(
      //floor it
      ((new Date().getTime() - //get today's date
        2 * 2 * 2 * 2 * 2 * 3 * 3 * 42227 * 100000) / //Yes, I have an iPhone //divide it by
        (1000 * 60 * 60 * 24)) % //A Day
        Ax.tips_array.length
        ...
        items: [
          {
            ...
            html:
              ...
              Ax.format.revision +
              '<br />' +
              'Format Revision Support: ' +
              Ax.format.support.min +
              ' - ' +
              Ax.format.support.max +
              '<br />' +
              'Graphic Editor: ' +
              Ax.onlypaths.version +
              '<br />' +
              'Testing: ' +
              Ax.v.dev +
              '<br />' +
              'Release Date: ' +
              Date.parseDate(Math.round(Ax.v.date), 'U') +
              ' (' +
              Ax.v.date +
              ')<br />' +
              '',
          ...
          },
          {
            ...
            html:
              'GPL v3 (http://www.gnu.org/licenses/gpl-3.0.txt) <br /><br />' +
              Ax.gpl +
              " <br /><br /><i>Please don't sue me</i>",
          },
          {
            title: 'Other',
            html:
              "Code: <a href='http://code.google.com/p/ajaxanimator'>http://code.google.com/p/ajaxanimator</a> " +
...
Ax.keys = {
  //An object with the key arrays that will be generated and converted into something user-readable
...
Ax.keyGuide = function() {
  //magickallyawesome function
  //Ax.gs(5); //report user statistics
  var generatedguide = ''
  for (var x in Ax.keys) {
    //generate the magical human-readable stuff
  ...
  initComponent: function() {
    Ext.apply(this, {
      ...
      items: {
        ...
        //html: "FAK"
        html:
          '<iframe src="http://antimatter15.com/ajaxanimator/server/doc/faq.htm" border="0" style="border:none;top: 0;left:0;width:100%;height:100%;"></iframe>',
      },
    })
  ...
  initComponent: function() {
    Ext.apply(this, {
      ...
      items: {
        ...
        //}
        html:
          '<iframe src="http://brwainer.110mb.com/ajaxanimator/manual/index.php" border="0" style="border:none;top: 0;left:0;width:100%;height:100%;"></iframe>',
      },
    })
  ...
  initComponent: function() {
    Ext.apply(this, {
      ...
      items: {
        ...
        cls: 'docs',
        html:
          '<iframe src="http://antimatter15.com/ajaxanimator/advanced.html" border="0" style="border:none;top: 0;left:0;width:100%;height:100%;"></iframe>',
      },
    })
    ...
    buttons: [
      ...
      },
      {
        ...
        handler: function() {
          Ax.msg(
            'Sending Bug Report',
            "We are sending your bug report... Or at least we'll make you think we are."
          )
          ErrorWindow.close()
        },
      },
...
Ax.donate = function() {
  Ext.MessageBox.alert(
    'Helping the Ajax Animator',
    'If you enjoy using the Ajax Animator and would like to help assist the project, please use the ad-supported version, report bugs, comment on desired features and spread the word.'
  )
}
...
Ax.tutorials_unavailable = function() {
  Ext.MessageBox.alert(
    'Interactive Tutorials Unavaliable',
    'Sorry, this feature is not finished yet.'
  )
}
        ...
        handler: function() {
          try {
            ...
            if (output.length > 140) {
              //tweet rule is good rule of thumb
              Ext.MessageBox.alert('Script Execution Output', output)
            } else {
...
Ax.plugins['Explode'] = function() {
  Ax.api.loop.frame(function(shape) {
    return Ax.api.transform.absolute(
      shape,
      Math.round(Math.random() * (Ax.canvasHeight - shape.height)),
      Math.round(Math.random() * (Ax.canvasWidth - shape.width))
    )
  })
}
  ...
  Ax.keymap = new Ext.KeyMap(document, [
    {
      ...
      fn: function(code, event) {
        if (!Ax.verify_keydown(code, event)) {
          return
        }
        Ax.toKeyframe()
      },
...
Ax.verify_keydown = function(code, event) {
  //koolio! this is sssooooooo much better than that old one! actually, come to think of it.. now it's sorta complex...

  if ([116, 117, 118].indexOf(code) != -1) {
    //if its one of the "banned" keycodes, such as F5 (reloads page), ALWAYS stop it's default behavior
  ...
  if (selectedText.length > 1) {
    return
  } //don't continue if there's anything in the selection

  if (['input', 'textarea'].indexOf(event.getTarget().tagName.toLowerCase()) == -1) {
    //ignore everything if it's a text element
    event.stopEvent() //yep..
    return true //oooo
  }
  return
    ...
    setTimeout(function() {
        ...
        setTimeout(function() {
          ...
          ds.first(Ax.urlprefs.load, function(data) {
            ...
            Ax.msg(
              ...
              'Animation ' + Ax.urlprefs.load + ' has been automatically loaded.'
            )
          })
        }, 100)
      }
      ...
      setTimeout(function() {
        ...
        if (!window.developer) {
          ...
          if (Ext.isIE) {
            //you know I miss the days of saying "Error: YOUR BROWSER SUCKS!"
...
function autopost(posturl, params, cb) {
  // random id
  var conv = '0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz',
    len = conv.length,
    ucb = 'ucb_'
  ...
  window['c' + ucb] = function() {
    try {
      if (iframe.contentWindow.location == 'about:blank') {
        //opera and safari load about:blank
        return
      }
    } catch (e) {}
  ...
  try {
    iframe = document.createElement(
      '<iframe id="' + ucb + '" name="' + ucb + '" onload="window.c' + ucb + '()">'
    )
  } catch (ex) {
    // IE
    iframe = document.createElement('iframe')
    iframe.id = iframe.name = ucb
    iframe.onload = window['c' + ucb]
  } // normal
